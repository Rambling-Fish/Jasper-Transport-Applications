...
import org.jasper.jLib.cat010.codec.Cat010Encoder;
import org.jasper.jLib.cat010.codec.Cat010Message;
...
public class Cat010ByteArrayGenerator {
	...
	public static byte[] getByteArray() throws Exception{
		Cat010Message msg;
		if(count % 4 == 0){
			msg = getPeriodicStatusMessage();
		}else{
			msg = getTargetReport();
		}
		count++;	
		return Cat010Encoder.doEncode(msg);
	}
	 ...
	 */
	public static byte[] getByteArry(String str) throws Exception{
		return getByteArray();
	}

	//static method to create Periodic Status Message
	private static Cat010PeriodicStatusMessage getPeriodicStatusMessage(){
